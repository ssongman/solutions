...
$ helm -n postgres ls
NAME            NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                   APP VERSION
my-admin        postgres        1               2026-02-28 16:39:46.938905 +0900 KST    deployed        pgadmin4-1.59.0         9.11
postgres        postgres        1               2026-02-07 06:32:06.087840417 +0000 UTC deployed        postgresql-18.2.4       18.1.0


# 현재 저장된 vaules.yaml 확인
$ helm -n postgres get values my-admin -o yaml
...
# helm upgrade - 2026.03.14
$ cat <<'EOF' | helm -n postgres upgrade my-admin runix/pgadmin4 -f -
ingress:
  enabled: true
  ingressClassName: nginx
  annotations:
...
$ helm -n postgres ls
NAME            NAMESPACE       REVISION        UPDATED                                 STATUS          CHART                   APP VERSION
my-admin        postgres        2               2026-03-14 12:25:23.429987 +0900 KST    deployed        pgadmin4-1.59.0         9.11
postgres        postgres        1               2026-02-07 06:32:06.087840417 +0000 UTC deployed        postgresql-18.2.4       18.1.0


kubectl -n postgres get pvc
kubectl -n postgres describe pvc
kubectl -n postgres get pods
helm -n postgres status my-admin
