...
![image-20240410154635602](./ktds블로그_MultiCluster.assets/image-20240410154635602.png)
...
![image-20240410154707753](./ktds블로그_MultiCluster.assets/image-20240410154707753.png)
...
![image-20240410160040274](./ktds블로그_MultiCluster.assets/image-20240410160040274.png)
...
![image-20240410160622936](./ktds블로그_MultiCluster.assets/image-20240410160622936.png)
...
![image-20240410163756971](./ktds블로그_MultiCluster.assets/image-20240410163756971.png)
...
![image-20240410163814358](./ktds블로그_MultiCluster.assets/image-20240410163814358.png)
...
![다중 클러스터 그림](./ktds블로그_MultiCluster.assets/clustermesh-2-39e9ebcad6babe51bfd318eb85f3da28.webp)





클러스터 서비스별로 작동 가능 여부를 동적으로 설정 가능하다. 예를들면, 업그레이드를 위해 일시적으로 오프라인을 유지해야 하는 경우나  리소스 부족으로 인해 서비스 장애와 같은 경우이다.  각 클러스터내 서비스의 접근을 동적으로 조정 하여 유연한 사용을 제공한다.

![다중 클러스터 그림](./ktds블로그_MultiCluster.assets/clustermesh-1-984767ca705b693437c8a83be4585557.png)
